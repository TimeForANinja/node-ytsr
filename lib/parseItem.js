...
const parseVideo = obj => {
  ...
  const authorUrl = author.navigationEndpoint.browseEndpoint.canonicalBaseUrl ||
  ...
  return {
    ...
    duration: isLive || upcoming || !obj.lengthText ? null : UTIL.parseText(obj.lengthText),
    uploaded_at: isLive || upcoming || !obj.publishedTimeText ? null : UTIL.parseText(obj.publishedTimeText),
