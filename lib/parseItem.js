...
const parseVideo = obj => {
  ...
  const authorImg = !author ? null: (
    obj.channelThumbnailSupportedRenderers ? obj.channelThumbnailSupportedRenderers.channelThumbnailWithLinkRenderer : { thumbnail: { thumbnails: [] }}
  )
